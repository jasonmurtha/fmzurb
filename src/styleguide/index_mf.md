...
<div class="row medium-up-2 large-up-3 xlarge-up-4 viewpoints" data-equalizer data-equalize-by-row="true">
  <div class="column">
    <div class="card background-concrete">
      <div class="card-divider" data-equalizer-watch>
        <div class="article-date">Mar 6, 2017</div>
      ...
      <section class="sidebar background-gray">
        <div class="row">
          <div class="column">
            ...
            <p class="flex-up"><a href="/aimi/">View how the index has <span class="icon-chevron-right-white">changed</span></a></p>
          </div>
        </div>
      </section>
    </aside>
