...
var s_account="freddiemacdev"
var s_somni=s_gi(s_account)
/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
/* Link Tracking Config */
s_somni.trackDownloadLinks=false
s_somni.trackExternalLinks=false
s_somni.trackInlineStats=false
s_somni.linkDownloadFileTypes=""
s_somni.linkInternalFilters=""
s_somni.linkLeaveQueryString=false
s_somni.linkTrackVars="None"
s_somni.linkTrackEvents="None"
s_somni.dynamicAccountSelection=true
s_somni.dynamicAccountList="freddiemacprod=freddiemac.com"
s_somni.eVar73='FM v2.0-20141215|SC H27.4'
...
+".length:i;t=s_somni.p_gpv(p.substring(0,i),u+'');if(t){t=t.indexOf('#')>-"
+"1?t.substring(0,t.indexOf('#')):t;}if(t)v+=v?d+t:t;p=p.substring(i="
+"=p.length?i:i+1)}return v");
s_somni.p_gpv=new Function("k","u",""
+"var s=this,v='',i=u.indexOf('?'),q;if(k&&i>-1){q=u.substring(i+1);v"
+"=s.pt(q,'&','p_gvf',k)}return v");
s_somni.p_gvf=new Function("t","k",""
+"if(t){var s=this,i=t.indexOf('='),p=i<0?t:t.substring(0,i),v=i<0?'T"
+"rue':t.substring(i+1);if(p.toLowerCase()==k.toLowerCase())return s."
+"epa(v)}return ''");
/********************************************************************
* Plugin: getTimeParting 3.4  */
s_somni.getTimeParting=new Function("h","z",""
...
s_somni.apl=new Function("l","v","d","u",""
+"var s=this,m=0;if(!l)l='';if(u){var i,n,a=s_somni.split(l,d);for(i=0;i<a."
+"length;i++){n=a[i];m=m||(u==1?(n==v):(n.toLowerCase()==v.toLowerCas"
+"e()));}}if(!m)l=l?l+d+v:v;return l");
/********************************************************************/
/* Utility Function: split v1.5 - split a string (JS 1.0 compatible) */
s_somni.split=new Function("l","d",""
...
s_somni.busUnit={
  ...
  lp:"singlefamily",
  lpoutreach:"singlefamily",
  ontrack:"singlefamily",
  purchasemarket:"singlefamily",
...
var somniTL = function(obj,lType,hrf,trig,name1,persona){
 ...
 s_somni.tl(obj,lType,name1);
 s_somni.linkTrackEvents='None';s_somni.events='';s_somni.linkTrackVars='None';
};

s_somni.usePlugins=true
 function s_somni_doPlugins(s_somni){
 var s_dt=s_somni.getTimeParting('n','-5'),s_tm=s_dt.split('|')[0], 
 ...
 s_fil=s_li>1?s_clr(s_wlp.split(':').slice(-1)[0]):s_path==""?"homepage":"";
 ...
 else if(s_somni.eVar11){s_somni.prop11=s_somni.eVar11;s_somni.events=s_somni.apl(s_somni.events,"event11",",",1)}
 if(s_somni.eVar12){s_somni.prop12=s_somni.eVar12}
 if(s_somni.eVar15){s_somni.prop15=s_somni.eVar15}
 if(s_chn=="blog"&&s_somni.pageType!=="errorPage"){
  s_somni.eVar1="fm|"+s_path;
  s_somni.eVar25=s_li>6?s_clr(s_wlp.substring(5,s_li)):"home";
  s_somni.eVar24=s_fil.length>1?s_fil:s_somni.eVar25;
  s_somni.prop24=s_somni.eVar24;s_somni.prop25=s_somni.eVar25;
  s_somni.events=s_somni.apl(s_somni.events,"event24",",",1);
 }
 if(document.referrer.match(/loanprospector\.com/) ){s_somni.eVar27="lp user"}
 else if(s_wlp.match(/debt:data:cgi-bin/)){s_somni.eVar27="debt securities user"}
 else if(s_wlp.match(/mbs:(cgi-bin|html)/)){s_somni.eVar27="mbs user"}
 ...
 s_somni.prop75=s_somni.eVar75=location.href
 if(s_somni.eVar1){s_somni.prop1=s_somni.eVar1;if(s_somni.linkTrackEvents=='None'){s_somni.events=s_somni.apl(s_somni.events,"event1",",",1)}}
 if(s_somni.eVar2){s_somni.prop2=s_somni.eVar2;s_somni.events=s_somni.apl(s_somni.events,"event2",",",1)}
 if(s_somni.eVar3){s_somni.prop3=s_somni.eVar3;s_somni.events=s_somni.apl(s_somni.events,"event3",",",1)}
 if(s_somni.eVar4&&s_somni.eVar4.length>1){s_somni.prop4=s_somni.eVar4;s_somni.events=s_somni.apl(s_somni.events,"event4",",",1)}
 if(s_somni.eVar5){s_somni.prop5=s_somni.eVar5}
 ...
 if(s_somni.eVar23){s_somni.prop23=s_somni.eVar23;s_somni.events=s_somni.apl(s_somni.events,"event23",",",1)}
 s_somni.eVar26=s_somni.getQueryParam('emlcmp');
 if(s_somni.eVar26){s_somni.prop26=s_somni.eVar26;s_somni.events=s_somni.apl(s_somni.events,"event26",",",1)} 
 if(s_somni.eVar27){s_somni.prop27=s_somni.eVar27}
 if(s_somni.events && s_somni.linkTrackEvents=="None"){s_somni.linkTrackEvents=s_somni.events}
 if(s_somni.events && s_somni.linkTrackVars=="None"){s_somni.linkTrackVars="events"} 
 
}
s_somni.doPlugins=s_somni_doPlugins

/* WARNING: Changing any of the below variables will cause drastic
changes to how your visitor data is collected.  Changes should only be
made when instructed to do so by your account manager.*/
s_somni.visitorNamespace="freddiemac"
s_somni.trackingServer="freddiemac.122.2o7.net"
